...
class robot:
    ...
    def sense(self):
        ...
        for i in range(len(self.landmarks)):
            landmarksX = self.landmarks[i][0]
            landmarksY = self.landmarks[i][1]
            
            dx = landmarksX - self.x + self.rand() * self.measurement_noise
            dy = landmarksY - self.y + self.rand() * self.measurement_noise
